...
def check_actual_sales_meterial_sales_obj(sale_person_id, material_sale_obj_id):
    ...
    obj = (
        ...
        .annotate(
            sum_exchange=Round2(
                (
                    F("detail_attach__incoming_price")
                    / F("detail_attach__attach_for_incoming__exchange_rates__exchange_rates")
                )
                * F("person_invoice_attach__exchange_rates__exchange_rates")
            )
        )
        .values(
...
def need_to_order(months=2):
    ...
    obj_for_range_time = MaterialSaleObject.objects.filter(
        ...
        "quantity",
        "detail_attach__detail_name__pk",
        "detail_attach__detail_name__name",
        "detail_attach__detail_name__part_num",
        "detail_attach__detail_name__attachment_part__type_spar_part",
        "detail_attach__pk",
        "detail_attach__quantity",
    )
