...
class Person(models.Model):
    ...
    PERSON_ROLE = [(MASTER, "Мастер"), (CLIENT, "Клиент"), (OWNER, "Собственник")]
...
class SparPart(models.Model):
    ...
    attachment_part = models.ForeignKey(
        "TypeSparPart", on_delete=models.SET_NULL, related_name="attachment_for_part", null=True
    )
    attachment_appliances = models.ForeignKey(
        "TypeAppliances", on_delete=models.SET_NULL, related_name="attachment_for_appliances", null=True
    )
    attachment_manufacturer = models.ForeignKey(
        "Manufacturer", on_delete=models.SET_NULL, related_name="attachment_for_manufacturer", blank=True, null=True
    )
    image_link = models.TextField("Фото", blank=False, null=True)
...
class Incoming(models.Model):
    ...
    ship = models.ForeignKey("Shipper", null=True, on_delete=models.SET_NULL, related_name="attash_incoming_list")
    exchange_rates = models.ForeignKey(
        "ExchangeRates", on_delete=models.SET_NULL, null=True, default=None, related_name="incoming_exchange_rates"
    )
...
class Shipper(models.Model):
    ...
    def __str__(self):
        return "{}... {} {}.{}".format(
            self.specification[:20], self.last_name, self.first_name[0], self.patronymic_name[0]
        )
...
class DetailInIncomList(models.Model):
    spar_part = models.ForeignKey(
        "SparPart", on_delete=models.SET_NULL, related_name="detail_detail_in_list", null=True
    )
...
class Detail(models.Model):
    ...
    incoming_price = models.FloatField(default=0, null=True)
    quantity = models.FloatField(default=0, null=True)
    attach_for_incoming = models.ForeignKey(
        "Incoming", on_delete=models.SET_NULL, related_name="attash_incom", null=True
    )
...
class DeviceUnderRepair(models.Model):
    ...
    comment = models.ForeignKey(
        "Comment", on_delete=models.SET_NULL, related_name="device_comment", blank=True, null=True
    )
...
class Device(models.Model):
    manufacturer = models.ForeignKey(
        "Manufacturer", on_delete=models.SET_NULL, related_name="device_manufacturer", null=True
    )
    type_appliances = models.ForeignKey(
        "TypeAppliances", on_delete=models.SET_NULL, related_name="device_type_appliances", null=True
    )
...
class VirtualSaleObject(models.Model):
    ...
    repair_invoice_attach = models.ForeignKey(
        "RepairInvoice", on_delete=models.SET_NULL, related_name="virtual_repair_invoice", default=None, null=True
    )
    person_invoice_attach = models.ForeignKey(
        "SalesPersonInvoice", on_delete=models.SET_NULL, related_name="virtual_person_invoice", default=None, null=True
    )
...
class MaterialSaleObject(models.Model):
    ...
    person_invoice_attach = models.ForeignKey(
        "SalesPersonInvoice", on_delete=models.SET_NULL, related_name="material_person_invoice", default=None, null=True
    )
...
class SalesPersonInvoice(models.Model):
    ...
    exchange_rates = models.ForeignKey(
        "ExchangeRates", on_delete=models.SET_NULL, null=True, default=None, related_name="sale_person_exchange_rates"
    )
...
class RepairInvoice(models.Model):
    repair_attach = models.ForeignKey(
        "DeviceUnderRepair", on_delete=models.SET_NULL, related_name="detail_invoice", null=True
    )
    exchange_rates = models.ForeignKey(
        "ExchangeRates", on_delete=models.SET_NULL, null=True, default=None, related_name="repair_exchange_rates"
    )
